...
const CATALOG = [
  ...
  { g:'Empresa / Establecimientos', items:[ ['caja','store','Consulta de caja'], ['cash-mng','cash','Cash management'], ['aprobaciones','approve','Aprobaciones'], ['admin-usuarios','users','Administración de usuarios'] ] },
